...
export class VehicleRespository extends GenericRepository<Vehicle, VehicleDTO> {
  constructor() {
    super({
  ...
  async create(entity: Vehicle, image?: MulterFile) {
    return (await this.createVehicle(parseObj(entity), image))!;
  }

  async update(entity: Vehicle, image?: MulterFile) {
